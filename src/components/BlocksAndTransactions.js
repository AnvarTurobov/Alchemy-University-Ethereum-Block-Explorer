  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className="bg-white p-6 rounded shadow">
        ...
        <ul>
          {latestBlocks && latestBlocks.slice(0, 6).map((block, index) => (
            <li key={index} className="flex justify-between items-center py-2 border-b">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-[#0ABAB5] font-bold text-blue-600">
        ...
        <Link to="/blocks">
          <button className="bg-gray-200 hover:text-[#0ABAB5] text-gray-700 font-bold py-2 px-4 rounded mt-4 w-full">
            View All Blocks
          </button>
        </Link>
      </div>
      ...
      <div className="bg-white p-6 rounded shadow">
        ...
        <ul>
          {latestBlocks && latestBlocks[0] && latestBlocks[0].transactions.slice(0, 6).map((tx, index) => (
            <li key={index} className="flex justify-between items-center py-2 border-b">
              <div className="flex items-center">
                <div className="bg-gray-100 p-2 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 text-gray-500">
                ...
                <div className="ml-4">
                  <p className="text-[#0ABAB5] font-bold"><Link to={`/transaction/${tx.hash}`}>{tx.hash.slice(0, 10)}...</Link></p>
